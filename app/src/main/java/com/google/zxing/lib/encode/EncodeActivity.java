...
package com.google.zxing.lib.encode;
...
import com.google.zxing.lib.FinishListener;
...
public final class EncodeActivity extends Activity {
    ...
    private void share() {
        ...
        try {
            // 生成不带 logo 图片
//            bitmap = encoder.mergeBitmap(encoder.encodeAsBitmap(),null);
            // 生成带 logo 图片
            bitmap = encoder.mergeBitmap(encoder.encodeAsBitmap(), ((BitmapDrawable) getResources().getDrawable(R.mipmap.ic_launcher)).getBitmap());
    ...
    protected void onResume() {
        ...
        try {
            ...
            // 生成不带 logo 图片
//            Bitmap bitmap = qrCodeEncoder.mergeBitmap(qrCodeEncoder.encodeAsBitmap(),null);
            // 生成带 logo 图片
            Bitmap bitmap = qrCodeEncoder.mergeBitmap(qrCodeEncoder.encodeAsBitmap(), ((BitmapDrawable) getResources().getDrawable(R.mipmap.ic_launcher)).getBitmap());
