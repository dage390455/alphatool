...
public class FilterDeviceInfoAdapter extends BaseExpandableListAdapter {

    private Context mContext;
    private Map<String, List<FilterData>> dataSet;
    private String[] parentArray;

    public FilterDeviceInfoAdapter(Context context, Map<String, List<FilterData>> dataSet, String[] parentArray) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switch (groupPosition) {
                    case Constants.FILTER_DEVICE_SWITCH:
                    case Constants.FILTER_DEVICE_NEARBY:
                    case Constants.FILTER_DEVICE_SIGNAL:
